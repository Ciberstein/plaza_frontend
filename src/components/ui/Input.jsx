  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {prefix && (
          <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-sm text-plaza-muted">
            {prefix}
          </span>
        )}
        ...
        {isPassword && (
          <button
            ...
            className="absolute inset-y-0 right-0 flex items-center px-3 text-plaza-muted hover:text-plaza-ink"
          >
