    ...
    >
      <div className="relative">
        ...
        {prefix && (
          <span
            className={clsx(
              ...
              props.disabled ? 'text-faint' : 'text-muted',
            )}
          >
            {prefix}
          </span>
        ...
        <input
          ...
          className={control({
            error: !!error,
            extra: [readable, prefix && 'pl-8', isPassword && 'pr-10'].filter(Boolean).join(' '),
          })}
          {...props}
        />
        ...
        {isPassword && (
          <button
            ...
            className="absolute inset-y-0 right-0 flex items-center px-3 text-muted transition-colors hover:text-ink disabled:cursor-not-allowed disabled:text-faint"
          >
